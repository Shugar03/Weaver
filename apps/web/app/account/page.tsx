...
// /account — panel del usuario (ADR-0007). El browser habla directo con el
// gateway (mismo base que /chat usa server-side: es URL pública del nodo).
